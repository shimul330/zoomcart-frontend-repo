...
const ManageProductTable = ({ register, errors, handleImageUpload, loading }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <select {...register("stock", { valueAsBoolean: true })} className="border p-2 rounded w-full">
                        <option value={true}>True</option>   {/* boolean true */}
                        <option value={false}>False</option> {/* boolean false */}
                    </select>
                </div>
